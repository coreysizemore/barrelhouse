							...
							<div class="content">
								...
								<?php
									...
									if (!empty($_POST)) {
										...
										$sql = "UPDATE tap_it SET approved = 'No', tapper = '', holder = '', location ='' WHERE id = '$_POST[num]'";
			
										if ($conn->query($sql) === TRUE) {
												
											echo "<div class='approved_wrapper'><p>The selected record has been removed.</p><a href='http://www.coreysizemore.com/barrelhouse/tap-it-tuesday-admin/'>Return to Admin Page</a></div>";
